...
namespace
{
const unsigned int sCurrentPresetVersion = 5;
...
void CTimeOfDayVariables::Reset()
{
	...
	//AddVar("HDR", "", "Vibrance", ITimeOfDay::PARAM_HDR_VIBRANCE, ITimeOfDay::TYPE_FLOAT, 0.5f, 0.0f, 2.0f);
	//AddVar("HDR", "", "Sharpening", ITimeOfDay::PARAM_HDR_SHARPENING, ITimeOfDay::TYPE_FLOAT, 0.0f, 0.0f, 50.0f);
	//AddVar("HDR", "", "Texture Sharpening", ITimeOfDay::PARAM_HDR_TEXTURESHARPENING, ITimeOfDay::TYPE_FLOAT, 0.0f, 0.0f, 50.0f);
