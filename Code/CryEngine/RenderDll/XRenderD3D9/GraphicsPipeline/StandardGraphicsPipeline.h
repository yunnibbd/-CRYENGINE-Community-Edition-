...
private:
	...
	// Custom fullscreen shader (no dedicated stage to avoid enum integration)
	CFullscreenPass                        m_fullScreenCustomPass;
	bool                                   m_fullScreenCustomInitialized = false;
