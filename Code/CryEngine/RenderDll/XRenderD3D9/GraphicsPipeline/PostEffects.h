...
//////////////////////////////////////////////////////////////////////////
class CVibrancePass : public IPostEffectPass
{
public:
	CVibrancePass(CGraphicsPipeline* pGraphicsPipeline)
		: m_passStrechRect(pGraphicsPipeline)
		, m_passVibrance(pGraphicsPipeline) {
	}
...
private:
	CStretchRectPass m_passStrechRect;
	CFullscreenPass  m_passVibrance;
};
