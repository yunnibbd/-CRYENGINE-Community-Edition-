...
struct SSvoTargetsSet
{
	SSvoTargetsSet(CGraphicsPipeline* pGraphicsPipeline)
		...
		, passRayTracedReflections(pGraphicsPipeline)
...
public:
	...
	void RayTracedReflectionsPass(SSvoTargetsSet* pTS);
	void SetupRayTracingReflectionConstants(CSvoFullscreenPass& rp);

	int  e_RT_Reflections = 1;
	float e_RT_Reflections_MaxDistance = 20.0f;
	float e_RT_Reflections_Roughness = 0.5f;
	int e_RT_Reflections_Samples = 1;
