...
int CRendererCVars::CV_r_GI_Mode;


int CRendererCVars::CV_r_rayTracingEnabled;
int CRendererCVars::CV_r_rayTracingGI;
int CRendererCVars::CV_r_rayTracingAO;
int CRendererCVars::CV_r_rayTracingShadows;
int CRendererCVars::CV_r_rayTracingReflections;
float CRendererCVars::CV_r_rayTracingGIIntensity;
int CRendererCVars::CV_r_rayTracingGIBounces;
float CRendererCVars::CV_r_rayTracingGIDistance;
float CRendererCVars::CV_r_rayTracingAOIntensity;
float CRendererCVars::CV_r_rayTracingAORadius;
int CRendererCVars::CV_r_rayTracingAOSamples;
float CRendererCVars::CV_r_rayTracingShadowIntensity;
float CRendererCVars::CV_r_rayTracingShadowDistance;
float CRendererCVars::CV_r_rayTracingShadowSoftness;
float CRendererCVars::CV_r_rayTracingReflectionIntensity;
float CRendererCVars::CV_r_rayTracingReflectionDistance;
float CRendererCVars::CV_r_rayTracingReflectionRoughness;
int CRendererCVars::CV_r_rayTracingDenoiser;
int CRendererCVars::CV_r_rayTracingRaysPerPixel;
int CRendererCVars::CV_r_rayTracingTemporal;
int CRendererCVars::CV_r_rayTracingDebug;
int CRendererCVars::CV_r_rayTracingResolutionScale;
int CRendererCVars::CV_r_rayTracingDebugDraw;

int CRendererCVars::CV_r_CustomShader;


int CRendererCVars::CV_r_PTGI_SamplesPerPixel = 4; // or your default value
int CRendererCVars::CV_r_PTGI_MaxBounces = 2;

float CRendererCVars::CV_e_svoTI_ReflectionStrength;
int CRendererCVars::CV_e_svoTI_TraceReflections;
int CRendererCVars::CV_e_svoTI_TraceHalfRes;
float CRendererCVars::CV_e_svoTI_TraceGlossinessThreshold;
...
#define r_ParticlesInstanceVerticesDefault 1
	...
	REGISTER_CVAR3("e_svoTI_TraceReflections", CV_e_svoTI_TraceReflections, 0, VF_NULL,
		"Enable ray traced reflections in SVOGI. 0=Off, 1=On \n");

	REGISTER_CVAR3("e_svoTI_TraceGlossinessThreshold", CV_e_svoTI_TraceGlossinessThreshold, 0.5f, VF_NULL,
		"Glossiness threshold (0-1): only trace reflections above this glossiness \n");

	REGISTER_CVAR3("e_svoTI_TraceHalfRes", CV_e_svoTI_TraceHalfRes, 0, VF_NULL,
		"If set, perform ray-traced reflections at half resolution for performance \n");

	REGISTER_CVAR3("e_svoTI_ReflectionStrength", CV_e_svoTI_ReflectionStrength, 1, VF_NULL,
		"Reflections intensity. (default: 0) \n");

	REGISTER_CVAR3("r_PTGI_MaxBounces", CV_r_PTGI_MaxBounces, 2, VF_NULL,
		"Number of bounces for PTGI\n");

	REGISTER_CVAR3("r_PTGI_SamplesPerPixel", CV_r_PTGI_SamplesPerPixel, 4, VF_NULL,
		"Number of rays cast per pixel in PTGI.\n"
		"Low quality: 1-2 samples per pixel \n"
		"Medium quality: 4-8 samples per pixel \n"
		"High quality: 16-32 samples per pixel \n"
		"Production quality: 64+ samples per pixel \n");
	...
	REGISTER_CVAR3("r_GI_Mode", CV_r_GI_Mode, 0, VF_NULL,
		"Switch between SVOGI (0) and Ray Tracing GI (1).\n");


	// RAY TRACING

	REGISTER_CVAR3("r_rayTracingEnabled", CV_r_rayTracingEnabled, 0, VF_NULL,
		"Enable Ray Tracing (0) - Disable, (1) - Enable\n");

	REGISTER_CVAR3("r_rayTracingGI", CV_r_rayTracingGI, 0, VF_NULL,
		"Enable Ray Tracing Global Illumination. (0) - Disable, (1) - Enable\n");

	REGISTER_CVAR3("r_rayTracingAO", CV_r_rayTracingAO, 0, VF_NULL,
		"Enable Ray Tracing Ambient Occlusion. (0) - Disable, (1) - Enable\n");

	REGISTER_CVAR3("r_rayTracingShadows", CV_r_rayTracingShadows, 0, VF_NULL,
		"Enable Ray Tracing Shadows. (0) - Disable, (1) - Enable\n");

	REGISTER_CVAR3("r_rayTracingReflections", CV_r_rayTracingReflections, 0, VF_NULL,
		"Enable Ray Tracing Reflections. (0) - Disable, (1) - Enable\n");

	REGISTER_CVAR3("r_rayTracingGIIntensity", CV_r_rayTracingGIIntensity, 1.0f, VF_NULL,
		"Ray Tracing Global Illumination Intensity\n");

	REGISTER_CVAR3("r_rayTracingGIBounces", CV_r_rayTracingGIBounces, 3.0f, VF_NULL,
		"Set Number of Bounces. More bounces means lower performance.\n");

	REGISTER_CVAR3("r_rayTracingGIDistance", CV_r_rayTracingGIDistance, 50.0f, VF_NULL,
		"Set Global Illumination Distance. Higher distance means lower performance.\n");

	REGISTER_CVAR3("r_rayTracingAOIntensity", CV_r_rayTracingAOIntensity, 1.0f, VF_NULL,
		"Set Intensity of Ray Tracing Ambient Occlusion.\n");

	REGISTER_CVAR3("r_rayTracingAORadius", CV_r_rayTracingAORadius, 1.0f, VF_NULL,
		"Set Radius of Ray Tracing Ambient Occlusion\n");

	REGISTER_CVAR3("r_rayTracingAOSamples", CV_r_rayTracingAOSamples, 5, VF_NULL,
		"Set the Number of Ambient Occlusion Samples\n");

	REGISTER_CVAR3("r_rayTracingShadowIntensity", CV_r_rayTracingShadowIntensity, 1.0f, VF_NULL,
		"Set the Intensity of Ray Tracing Shadows\n");

	REGISTER_CVAR3("r_rayTracingShadowDistance", CV_r_rayTracingShadowDistance, 50.0f, VF_NULL,
		"Set the Distance of Ray Tracing Shadows. Higher distance means lower performance.\n");

	REGISTER_CVAR3("r_rayTracingShadowSoftness", CV_r_rayTracingShadowSoftness, 1.0f, VF_NULL,
		"Set the Softness of Ray Tracing Shadows.\n");

	REGISTER_CVAR3("r_rayTracingReflectionIntensity", CV_r_rayTracingReflectionIntensity, 1.0f, VF_NULL,
		"Set the Intensity of Ray Tracing Reflections\n");

	REGISTER_CVAR3("r_rayTracingReflectionDistance", CV_r_rayTracingReflectionDistance, 50.0f, VF_NULL,
		"Set the Distance of Ray Tracing Reflections. Higher distance means lower performance.\n");

	REGISTER_CVAR3("r_rayTracingReflectionRoughness", CV_r_rayTracingReflectionRoughness, 1.0f, VF_NULL,
		"Set the Roughness of Ray Tracing Reflections.\n");

	REGISTER_CVAR3("r_rayTracingDenoiser", CV_r_rayTracingDenoiser, 1, VF_NULL,
		"Enable Ray Tracing Denoiser. (0) - Disable, (1) - Enable\n");

	REGISTER_CVAR3("r_rayTracingRaysPerPixel", CV_r_rayTracingRaysPerPixel, 1, VF_NULL,
		"Set the Number of Rays Per Pixel. Higher number means lower performance.\n");

	REGISTER_CVAR3("r_rayTracingTemporal", CV_r_rayTracingTemporal, 1, VF_NULL,
		"Enable TAA for Ray Tracing. (0) - Disable, (1) - Enable\n");

	REGISTER_CVAR3("r_rayTracingDebug", CV_r_rayTracingDebug, 1, VF_NULL,
		"Enable Ray Tracing Debug. (0) - Disable, (1) - Enable\n");

	REGISTER_CVAR3("r_rayTracingResolutionScale", CV_r_rayTracingResolutionScale, 1, VF_NULL,
		"Set Ray Tracing Resolution Scale. Higher number means lower performance.\n");

	REGISTER_CVAR3("r_rayTracingDebugDraw", CV_r_rayTracingDebugDraw, 0, VF_NULL,
		"Debug Mode 2\n");


	REGISTER_CVAR3("r_CustomShader", CV_r_CustomShader, 0, VF_NULL,
