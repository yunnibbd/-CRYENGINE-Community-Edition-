...
public:
	CSharpening()
	{
		...
		AddParamFloat("Sharpening_TextureAmount", m_pTextureSharpenAmount, 0.0f); 
		// Register "Active" parameter
		AddParamBool("Sharpening_Active", m_pActive, false);
	}
...
private:
	...
	CEffectParam* m_pTextureSharpenAmount;
};

////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////

class CVibrance : public CPostEffect
{
public:
	CVibrance()
	{
		m_nID = EPostEffectID::Vibrance;

		AddParamFloat("FilterVibrance_Amount", m_pAmount, 1.0f);
		AddParamInt("FilterSharpening_Type", m_pType, 0);
	}
...
public:
	CColorGrading()
	{
		...
		AddParamFloatNoTransition("ColorGrading_SharpenAmount", m_ptextureSharpenAmount, 1.0f);
