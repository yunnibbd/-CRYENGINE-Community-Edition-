...
public:
	...
	DeclareStaticConstIntCVar(CV_r_RayTracing, 1);
	...
	static float CV_r_TextureSharpening;

	static float CV_r_Vibrance;
	...
	// Code/CryEngine/RenderDll/XRenderD3D9/GraphicsPipeline/DXRRayTracingCVars.h

#pragma once


	static int CV_r_DXRReflectionsEnabled;
	static float CV_r_DXRReflectionsMaxDist;
	static float CV_r_DXRReflectionsRoughThreshold;
	static int CV_r_DXRReflectionsMaxBounces;
	static int CV_r_DXRSpecularEnabled;
	static float CV_r_DXRSpecularStrength;
	static int CV_r_DXRSpecularSamples;
	static int CV_r_DXRDiffuseEnabled;
	static float CV_r_DXRDiffuseStrength;
	static int CV_r_DXRDiffuseSamples;

	static int   CV_r_SSReflections;
	//static int	 CV_r_RayTracing;
